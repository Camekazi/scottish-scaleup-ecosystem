...
Request edit access to the Google Sheet.

## Data Sources

This map includes publicly available information about:
- Scale-Up Scotland panel members and alumni
- CodeBase / Techscaler network
- FinTech Scotland ecosystem
- Scottish Enterprise / Invest in Scotland connections
- Public LinkedIn profiles of ecosystem leaders
...
- **Data**: Google Sheets (Elements + Connections tabs)
